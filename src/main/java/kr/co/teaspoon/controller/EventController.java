...
public class EventController {
    ...
    public void imageUpload(HttpServletRequest request,
        ...
        try{
            ...
            //이미지 경로 생성
            String path = "C:\\hkdev\\proj\\solo\\chunjaeSoloProject3\\pro3\\src\\main\\webapp\\resources\\upload" + "ckImage/";	// 이미지 경로 설정(폴더 자동 생성)
            ...
            String fileUrl = "/pro3_war/event/ckImgSubmit.do?uid=" + uid + "&fileName=" + fileName; // 작성화면
    ...
    public void ckSubmit(@RequestParam(value="uid") String uid
        ...
        //서버에 저장된 이미지 경로
        String path = "C:\\hkdev\\proj\\solo\\chunjaeSoloProject3\\pro3\\src\\main\\webapp\\resources\\upload" + "ckImage/";	// 저장된 이미지 경로
        //String path = request.getRealPath("/resource/uploadckImage/");
