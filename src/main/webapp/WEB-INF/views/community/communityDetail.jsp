...
<section class="page-title background-primary is-relative"  style="background-image: url('${path}/resources/images/bannerPage.jpg'); background-position: center; background-size: cover; height: 200px;">
    <div class="container">
        <div class="has-text-centered" style="padding-top: 60px;">
            <h1 class="has-text-white font-tertiary" style="font-size: 40px; "> 커뮤니티 상세보기 </h1>
        </div>
    </div>
</section>
<!-- 배너 영역 끝 -->
    ...
    <div class="container">
        <form action="${path}/comment/insert.do" method="post" class="columns mt-5">
            ...
            <div class="column">
                ...
                <input type="submit" class="btn btn-sm btn-primary ml-4" style="color:#fff; text-decoration:none;height:72px" value="전송">
            </div>
        </form>
    </div>
    <div class="container">
