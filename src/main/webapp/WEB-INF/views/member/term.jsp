        ...
        <div class="columns is-desktop is-justify-content-center">
            <div class="column is-8-desktop">
                <div class="p-6 shadow rounded content">
                    <h3 class="has-text-centered" style="font-weight: bold;"> 약관 동의 </h3>
                    <hr>
                    ...
                    <div class="column is-6-tablet is-12 has-text-right">
                        <button class="button is-primary is-rounded is-medium" id="in_btn1" style=" background-color :#ff3369;"> 다음 단계 </button>
                    </div>
                </div>
            </div>
        </div>
